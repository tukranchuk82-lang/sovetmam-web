...
const TOPICS: Record<string, { title: string; short: string }> = {
  ...
  business: {
    title: "Бизнес",
    short:
      "Что дают семьям торговые сети и компании: скидки, кешбэк, карты со льготами.",
  },
  nko: {
    title: "НКО",
    short:
      "Помощь от фондов и некоммерческих организаций: лекарства, сопровождение, психологическая и юридическая поддержка.",
  },
  // Темы ниже с главной больше не открываются (плитки заменены на «Бизнес» и
  // «НКО»), но страницы оставлены рабочими: разметка topic-shops /
  // topic-kids-goods в базе сохранена и по прямой ссылке всё открывается.
  shops: {
    title: "Магазины",
