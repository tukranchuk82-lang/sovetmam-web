...
> = {
  ...
  planning: {
    title: "Планируем ребёнка",
    short:
      "Меры для тех, у кого детей пока нет: лечение бесплодия и ЭКО, возврат налога за лечение, жильё молодой семье.",
    filter: (m) => cat(m, "planning"),
  },
  "young-family": {
    title: "Молодая семья",
