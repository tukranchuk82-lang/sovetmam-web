...
function AuthGate() {
  return (
    <div className="flex h-full flex-col items-center justify-center px-6 py-8 text-center">
      <div className="flex size-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#c9002f] to-rose-700 text-white shadow-[0_10px_24px_-8px_rgba(201,0,47,0.55)]">
