...
import { ORG_NAME_GENITIVE, ORG_NAME_PLAIN } from "@/lib/org-brand";
...
export const metadata: Metadata = {
  ...
  description: `Шпаргалка для родителей от ${ORG_NAME_GENITIVE}: все меры поддержки семей с детьми — федеральные, региональные, муниципальные, от работодателя и вузов. Пройдите анкету и узнайте, что положено именно вам.`,
  applicationName: "Шпаргалка для родителей",
  authors: [{ name: ORG_NAME_PLAIN }],
  creator: ORG_NAME_PLAIN,
  publisher: ORG_NAME_PLAIN,
