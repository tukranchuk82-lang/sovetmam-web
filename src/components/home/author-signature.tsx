// Здесь, в подписи под фото, «Совет матерей» остаётся всегда — по просьбе Тани
// (25.09.2026) при временной подмене названия организации по остальному
// приложению (см. lib/org-brand.ts). Поэтому название вписано напрямую, а не
// берётся из компонента OrgName и флага TEMP_BRAND: возврат бренда этот блок
// не затрагивает. Правило про ёлочки и неразрывность сохраняем.
  ...
  return (
    <div className={className} style={{ fontFamily: "var(--font-inter), sans-serif" }}>
      ...
      >
        ...
        <span className="whitespace-nowrap">«Совет матерей»</span>,
