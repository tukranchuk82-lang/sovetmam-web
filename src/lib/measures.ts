...
import type { PrioritySituationKey } from "./taxonomy";
...
export interface UserProfile {
   ...
   * Меры по ней подбор поднимает отдельным блоком в начало выдачи.
   * `null` — человек не выбрал (или анкета заполнена до появления вопроса).
   */
